      ...
      <div className="row ">
        ...
        <div className="col-12 col-sm-6 col-lg-6">
          ...
          <p>
            ...
            more. <br></br> Prior to my transition into web development, I
            provided IT helpdesk support at a startup enterprise, which helped
            me develop strong problem-solving skills, attention to detail, and
            the ability to work well under pressure. I also learned how to
            communicate effectively with both technical and non-technical
            stakeholders, a skill that I believe will be invaluable in my future
            work as a developer.
            <br></br>At Le Wagon, I worked on several projects that challenged
            ...
            Rails, JavaScript, and API (Mapbox). <br></br> I am excited about
            the opportunity to bring my technical expertise, strong work ethic,
            and dedication to continuous learning to your team. I am committed
            to delivering high-quality work and taking on new challenges. I am
