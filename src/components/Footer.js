    ...
    <div className="col-lg-3 col-md-2 col-sm-6">
      <div className="row">
        <div className="col">
          ...
          <br />
          <a href="" className="footer-nav">Aboutme</a>
          <br />
          <a href="" className="footer-nav">Service</a>
          <br />
        </div>
        <div className="col">
          <a href="" className="footer-nav">Experiences</a>
          <br />
          <a href="" className="footer-nav">TextFromLove </a>
          <br />
